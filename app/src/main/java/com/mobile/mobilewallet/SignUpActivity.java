...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etPassword = findViewById(R.id.editT_confirmpassword);
        etEmail = findViewById(R.id.et_email);

        Button signup = findViewById(R.id.button);
        signup.setOnClickListener(x->{
            boolean isValid = throwEmptyNessError(new int[]{R.id.editT_confirmpassword
            ...
            if (isValid && errorMessage == null){
                ...
                user.put("userId", String.valueOf(1));
